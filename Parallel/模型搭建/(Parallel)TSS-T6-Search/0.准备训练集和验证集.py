import numpy as np
tmm_data = np.loadtxt('totalfeatures/tmm_train&valiation_totalfeatures.txt')
matmul_data = np.loadtxt('totalfeatures/matmul_train&valiation_totalfeatures.txt')
dsyr2k_data = np.loadtxt('totalfeatures/dsyr2k_train&valiation_totalfeatures.txt')
dsyrk_data = np.loadtxt('totalfeatures/dsyrk_train&valiation_totalfeatures.txt')
gemm_data = np.loadtxt('totalfeatures/gemm_train&valiation_totalfeatures.txt')
trmm_data = np.loadtxt('totalfeatures/trmm_train&valiation_totalfeatures.txt')
