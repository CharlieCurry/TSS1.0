...
/* Start of CLooG code */
if ((PS1 >= 1) && (PS3 >= 1)) {
  for (t2=0;t2<=floord(PS1-1,512);t2++) {
    for (t3=0;t3<=floord(PS3-1,512);t3++) {
      for (t4=512*t2;t4<=min(PS1-1,512*t2+511);t4++) {
        lbv=512*t3;
        ubv=min(PS3-1,512*t3+511);
#pragma ivdep
#pragma vector always
  ...
  if (PS2 >= 1) {
    for (t2=0;t2<=floord(PS1-1,512);t2++) {
      for (t3=0;t3<=floord(PS3-1,512);t3++) {
        for (t4=0;t4<=floord(PS2-1,512);t4++) {
          for (t5=512*t2;t5<=min(PS1-1,512*t2+511);t5++) {
            for (t6=512*t4;t6<=min(PS2-1,512*t4+511);t6++) {
              lbv=512*t3;
              ubv=min(PS3-1,512*t3+511);
#pragma ivdep
#pragma vector always
