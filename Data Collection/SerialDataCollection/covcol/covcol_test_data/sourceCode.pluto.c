...
if ((PS1 >= 1) && (PS2 >= 1)) {
  if (PS3 >= 1) {
    for (t2=0;t2<=min(floord(PS1-1,512),floord(PS2-1,512));t2++) {
      for (t3=t2;t3<=floord(PS2-1,512);t3++) {
        for (t4=0;t4<=floord(PS3-1,512);t4++) {
          for (t5=512*t2;t5<=min(min(PS1-1,PS2-1),512*t2+511);t5++) {
            for (t6=512*t4;t6<=min(PS3-1,512*t4+511);t6++) {
              lbv=max(512*t3,t5);
              ubv=min(PS2-1,512*t3+511);
#pragma ivdep
#pragma vector always
              for (t7=lbv;t7<=ubv;t7++) {
                C[t5][t7]+=A[t6][t5]*A[t6][t7];;
              }
            }
          }
        }
  ...
  for (t2=0;t2<=min(floord(PS1-1,512),floord(PS2-1,512));t2++) {
    for (t3=t2;t3<=floord(PS2-1,512);t3++) {
      for (t4=512*t2;t4<=min(min(PS1-1,PS2-1),512*t2+511);t4++) {
        lbv=max(512*t3,t4);
        ubv=min(PS2-1,512*t3+511);
#pragma ivdep
#pragma vector always
